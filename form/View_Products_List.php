...
<div class="wrapper">
      ...
      <div class="container-fluid">
		...
		<div class="card">
            <div class="card-header">
              <h3 class="card-title">View Products List Information</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
              <?php
					$sql1 = mysqli_query($dbConn,"select * from products order by pro_id DESC");
 ...
 <td><center>
   ...
   <a href="Edit_Product.php?P_ID=<?php echo $P_ID; ?>" class="btn btn-success btn-sm" role="button">Edit</a><br>
 <br>
 
 <a href="JavaScript:if(confirm('Are You Sure To Delete This Product ?')==true)
{window.location='Delete_Product.php?P_ID=<?php echo $P_ID; ?>';}" class="btn btn-danger btn-sm" role="button">Delete</a></center></td>                     
