...
<div class="wrapper">
      ...
      <div class="container-fluid">
		...
		<div class="card">
            <div class="card-header">
              <h3 class="card-title">View Customers List Information</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
             ...
             <?php
					...
					while ($row1 = mysqli_fetch_array($sql1)){
						...
						$Add_Date_Time = $row1['customer_add_date'];
 ...
 <td><center>
    ...
    <a href="Edit_Customer.php?C_ID=<?php echo $C_ID; ?>" style="width:52px" class="btn btn-success btn-sm" role="button">Edit</a><br>
<br>
 
 <a href="JavaScript:if(confirm('Are You Sure To Delete This Customer ?')==true)
{window.location='Delete_Customer.php?C_ID=<?php echo $C_ID; ?>';}" class="btn btn-danger btn-sm" role="button">Delete</a></center></td>                     
