...
$insert = mysqli_query($dbConn,"insert into products (cat_id,pro_name,pro_desc,pro_image,pro_quantity,pro_price,pro_color,pro_size) values ('$C_ID','$Name','$Description','$file','$Quantity','$Price','$Color','$Size')");
      ...
      <div class="container-fluid">
		...
		<div class="card">
            <div class="card-header">
              <h3 class="card-title">Add New Product Information</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
...
?>  			
                  ...
                  <div class="form-group">
				   ...
				   <div class="form-group">
                    ...
                    <input type="number" min="1" class="form-control" name="Price" placeholder="Product Price">
                  </div>
				   ...
				   <div class="form-group">
                    ...
                    <input type="number" min="1" class="form-control" name="Quantity" placeholder="Product Quantity">
                  </div>
