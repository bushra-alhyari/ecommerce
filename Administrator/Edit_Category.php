...
$sql1 = mysqli_query($dbConn,"select * from categories where cat_id='$C_ID'");
$row1 = mysqli_fetch_array($sql1);



$Category_Name = $row1['cat_name'];
$Category_Picture = $row1['cat_image'];
...
$Picture =  $_FILES["Picture"]["name"];
    if ($Picture==''){
$update = mysqli_query($dbConn,"UPDATE categories set cat_name='$Category_Name' where cat_id='$C_ID'");
}
else
{
   ...
   move_uploaded_file($_FILES["Picture"]["tmp_name"], "Products_Pictures/" . $_FILES["Picture"]["name"]);  
    ...
    $update = mysqli_query($dbConn,"UPDATE categories set cat_name='$Category_Name' ,cat_image= '$Picture' where cat_id='$C_ID'");
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="Category_Name" value="<?php echo $Category_Name; ?>" placeholder="Category Name">
				          ...
				          <div class="form-group">
                        Category Picture: 
                        <label for="cc-name" class="control-label mb-1">Category Picture: </label>
                        <input type="file" name="Picture" />
                        <img src="<?php echo $Category_Picture; ?>"  width="150" hight="150"/>
                        </div>
