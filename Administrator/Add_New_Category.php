...
$file;
  $insert="SELECT * from categories where cat_name='$Category_Name'";
  $select = mysqli_query($dbConn,$insert);
...
$insert = mysqli_query($dbConn,"INSERT into categories (cat_name,cat_image) values ('$Category_Name','$file')");
      ...
      <div class="container-fluid">
		...
		<div class="card">
            <div class="card-header">
              <h3 class="card-title">Add New Category Information</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
