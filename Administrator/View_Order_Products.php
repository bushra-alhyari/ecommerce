      ...
      <div class="container-fluid">
		...
		<div class="card">
            <div class="card-header">
              <h3 class="card-title">View Order Products List Information</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
               <?php
					$sql1 = mysqli_query($dbConn,"select * from sub_orders where order_id='$O_ID'");
					while ($row1 = mysqli_fetch_array($sql1)){
						
						$product_id = $row1['pro_id'];
						$quantity = $row1['sub_quantity'];
						$price = $row1['sub_price'];
						$total_price = $row1['sub_total_price'];

					$sql2 = mysqli_query($dbConn,"select * from products where pro_id='$product_id'");
					$row2 = mysqli_fetch_array($sql2);

						$Name = $row2['pro_name'];
						$Description = $row2['pro_desc'];
						$Picture = $row2['pro_image'];
						$Color = $row2['pro_color'];
						$Size = $row2['pro_size'];
