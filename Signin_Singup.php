...
$insert = mysqli_query($dbConn,"insert into customers (customer_name,customer_email,customer_password,mobile,address,customer_status) values ('$customer_name','$customer_email','$customer_password','$mobile','$address','Active')");
				...
				<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
					<form action="" method="post">
						...
						<div class="bor8 m-b-20 how-pos4-parent">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="customer_name" placeholder="Your Name">
						</div>



<div class="bor8 m-b-20 how-pos4-parent">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="email" name="customer_email" placeholder="Your Email Address">
						</div>



<div class="bor8 m-b-20 how-pos4-parent">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="password" name="customer_password" placeholder="Your Password">
						</div>
						...
						<div class="bor8 m-b-20 how-pos4-parent">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="mobile" placeholder="Your Mobile">
						</div>
...
<div class="bor8 m-b-20 how-pos4-parent">
						...
						<button name="Submit2" class="flex-c-m stext-101 cl0 size-121 bg3 bor1 hov-btn3 p-lr-15 trans-04 pointer">
							Signin
						</button>
					</form>
				</div>
