					...
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							...
							<div class="layer-slick1 animated visible-false" data-appear="zoomIn" data-delay="1600">
								<a href="allproducts.php" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04">
									Shop Now
								</a>
							</div>
						</div>
...
<div class="p-b-10 txt-center">
		...
		<div class="row isotope-grid">
				 ...
				 <?php
					$sql1 = mysqli_query($dbConn,"select * from products where pro_quantity>0 order by pro_date_time DESC limit 8");
					while ($row1 = mysqli_fetch_array($sql1)){
	...
	<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
			...
			<div class="flex-c-m flex-w w-full p-t-45">
				<a href="allproducts.php" class="flex-c-m stext-101 cl5 size-103 bg2 bor1 hov-btn1 p-lr-15 trans-04">
					Load More
				</a>
			</div>
		</div>
